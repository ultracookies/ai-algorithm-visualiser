  ...
  return (
    <div className="w-full bg-slate-900">
      <div className="flex flex-row items-center justify-center">
        <a
          href=""
          className="text-white p-2 m-2 rounded-md hover:bg-slate-600 transition-all duration-300"
        >
          Traditional Machine Learning
        </a>
        <a
          href=""
          className="text-white p-2 m-2 rounded-md hover:bg-slate-600 transition-colors duration-300"
        >
          Deep Learning
        </a>
        <a
